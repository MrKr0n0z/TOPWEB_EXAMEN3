    ...
    <>
      ...
      <div style={{ backgroundColor: '#F5F3EF', minHeight: '100vh' }}>
        ...
        <div style={{ padding: '40px 24px' }}>
          <div style={{ height: '28px', width: '160px', backgroundColor: '#E0DDD6', borderRadius: '6px', marginBottom: '24px' }} className="skeleton" />
          {[1,2,3,4,5,6].map(i => <div key={i} style={{ height: '48px', backgroundColor: '#FFFFFF', borderRadius: '8px', marginBottom: '8px', border: '0.5px solid #E0DDD6' }} className="skeleton" />)}
        </div>
      </div>
    </>
  );
